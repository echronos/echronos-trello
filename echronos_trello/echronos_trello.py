...
class Task:
    ...
    def _get_description(self):
        ...
        section_testing = "# Testing\n\n* core repository: [![](https://travis-ci.org/echronos/echronos.svg?branch={0})](https://travis-ci.org/echronos/echronos/branches) [![](https://ci.appveyor.com/api/projects/status/u0l9tcx3r8x9fwj0/branch/{0}?svg=true)](https://ci.appveyor.com/project/stefangotz/echronos/branch/{0})\n* client repository: [![](https://travis-ci.org/echronos/test-client-repo.svg?branch={0})](https://travis-ci.org/echronos/test-client-repo/branches) [![](https://ci.appveyor.com/api/projects/status/wbyntsf0a5crcl62/branch/{0}?svg=true)](https://ci.appveyor.com/project/stefangotz/test-client-repo/branch/{0})\n\n".format(self.name)
